...
void display_anti_horario(ssd1306_t *ssd); // Inicia a exibição da tela de início
void display_horario(ssd1306_t *ssd); // Inicia a exibição da tela de início
void display_inicio(ssd1306_t *ssd); // Inicia a exibição da tela de início
