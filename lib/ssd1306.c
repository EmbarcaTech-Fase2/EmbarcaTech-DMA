...
void display_anti_horario(ssd1306_t *ssd){
  ssd1306_fill(ssd, false); // Limpa o display
  ssd1306_draw_string(ssd, "Rotacionando", 18, 10); // Desenha uma string
  ssd1306_rect(ssd, 0, 0, 128, 25, true, false);
  ssd1306_draw_string(ssd, "Sentido", 32, 30); // Desenha uma string
  ssd1306_draw_string(ssd, "Anti-Horario", 18, 48); // Desenha uma string
  ssd1306_send_data(ssd); // Atualiza o display
}

// Função para exibir a tela sobre
void display_horario(ssd1306_t *ssd){
  ssd1306_fill(ssd, false); // Limpa o display
  ssd1306_draw_string(ssd, "Rotacionando", 18, 10); // Desenha uma string
  ssd1306_rect(ssd, 0, 0, 128, 25, true, false);
  ssd1306_draw_string(ssd, "Sentido", 32, 30); // Desenha uma string
  ssd1306_draw_string(ssd, "Horario", 32, 48); // Desenha uma string       
  ssd1306_send_data(ssd); // Atualiza o display
}

// Função para exibir a tela sobre
void display_inicio(ssd1306_t *ssd){
  ssd1306_fill(ssd, false); // Limpa o display
  ssd1306_draw_string(ssd, "Aperte A ou B", 12, 10); // Desenha uma string
  ssd1306_rect(ssd, 0, 0, 128, 25, true, false);
  ssd1306_draw_string(ssd, "A: Horario", 3, 30); // Desenha uma string
  ssd1306_draw_string(ssd, "B: Anti-Horario", 3, 48); // Desenha uma string       
  ssd1306_send_data(ssd); // Atualiza o display
}